...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'booking_id', tenantPath: [], userPath: [] },
  'booking.update': { roles: ['tenant-roles'], key: 'booking_id', tenantPath: [], userPath: [] },
  'booking.delete': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'booking_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['end-user'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['end-user'];
